 ...
 *
 * The overlay is rendered through a portal on <body> so it always covers the
 * whole screen — otherwise an ancestor card (which uses backdrop-blur, and so
 * becomes the containing block for fixed positioning) would trap it.
 */
